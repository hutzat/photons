...
classdef t3PCFS<dynamicprops
    ...
    methods
        function obj=t3PCFS(PCFS_folder,buffer_size)
            ...
            for i=3:numel(obj.files)
                ...
                if strcmp(ext,'.photons')== true
                    if strcmp(f_name(1:3),'tau')==0;
                        if strcmp(f_name(1:3),'sum')==0;
                            obj.(f_name).arrival_time_sorting(f_name,strcat(tau_id,f_name),tau)
                        else
                            obj.(f_name(12:end)).arrival_time_sorting(f_name,strcat(tau_id,f_name),tau)
                        end
                    end
                end
            end
